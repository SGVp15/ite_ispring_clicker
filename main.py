...
def wait_windows(name_like: str, time_second=10):
...
if __name__ == '__main__':
    for exam in EXAMS:
        ...
        for num in folders:
            ...
            subprocess.run(["C:\Program Files\iSpring\Suite 11\bin32\ispringlauncher.exe",os.path.join(BASE_PATH, exam, f'{exam}_{num}.quiz')])
